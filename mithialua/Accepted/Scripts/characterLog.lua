characterLog = {
	dropLog = function(mob, dropItems, dropAmounts)
		...
		local dir, text = "../mithialua/History/logs/drops/drops_log_" .. os.date("%m.%d.%Y") .. ".txt", ""
	...
	bossKillLog = function(mob, groupMembers)
		...
		local names = {}
		local dir, text = "../mithialua/History/logs/boss_kills/boss_kill_log_" .. os.date("%m.%d.%Y") .. ".txt", ""
	...
	whisperLog = function(dstName, srcName, msg)
		...
		local file1 = "../mithialua/History/logs/chatlogs/whispers/" .. dstName .. "<=>" .. srcName .. "_" .. os.date("%m.%d.%Y") .. ".txt"
		local file2 = "../mithialua/History/logs/chatlogs/whispers/" .. srcName .. "<=>" .. dstName .. "_" .. os.date("%m.%d.%Y") .. ".txt"
	...
	clanChatLog = function(srcName, speech)
		...
		local dir, text = "../mithialua/History/logs/chatlogs/clan/" .. getClanName(player.clan) .. "_full_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	groupChatLog = function(srcName, speech)
		...
		local dir, text = "../mithialua/History/logs/chatlogs/groups/groupChatLog_full_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	noviceChatLog = function(srcName, speech)
		...
		local dir, text = "../mithialua/History/logs/chatlogs/novice/noviceChatLog_full_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	subPathChatLog = function(srcName, speech)
		...
		local dir, text = "../mithialua/History/logs/chatlogs/subpath/" .. player.className .. "_full_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	exchangeLogWrite = function(player1, player2)
		...
		local dir, text = "../mithialua/History/logs/exchange/exchange_log_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	massExchangeWrite = function(player1, player1gold, player1items, player2, player2gold, player2items)
		...
		local dir, text = "../mithialua/History/logs/exchange/mass_exchange_log_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	carnageTeamChatLog = function(text)
		...
		local dir = "../mithialua/History/logs/chatlogs/events/carnageTeamChatLog_" .. os.date("%m.%d.%Y") .. ".txt"
		local file = io.open(dir, "a+")
	...
	bottingLog = function(player, inputText)
		...
		local dir1 = "../mithialua/History/logs/characterlog/log_" .. name .. "_" .. os.date("%m.%d.%Y") .. ".txt"
		local dir2 = "../mithialua/History/logs/botting/botting_log_" .. os.date("%m.%d.%Y") .. ".txt"
	...
	wisdomStarDailyTotal = function()
		...
		local dir, text = "../mithialua/History/logs/wisdom_star/wisdomStarLog_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	sage = function(player, speech)
		...
		local dir, text = "../mithialua/History/logs/chatlogs/sage/sageLog_full_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	localChat = function(player, speech)
		...
		local dir, text = "../mithialua/History/logs/chatlogs/general/chatLog_full_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	gmSpeechWrite = function(player, speech)
		...
		local dir, text = "../mithialua/History/logs/chatlogs/gm/chatLog_" .. player.name .. "_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	speechWrite = function(player, speech)
		...
		local dir, text = "../mithialua/History/logs/chatlogs/characters/chatLog_" .. player.name .. "_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	loginLog = function(player)
		...
		local dir, text = "../mithialua/History/logs/characterlog/log_" .. name .. "_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	nameChangeWrite = function(player, oldName)
		...
		local dir1, text = "../mithialua/History/logs/characterlog/log_" .. name .. "_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file1 = io.open(dir1, "a+")

		local dir2 = "../mithialua/History/logs/nameChanges/nameChangeLog_" .. os.date("%m.%d.%Y") .. ".txt"
		local file2 = io.open(dir2, "a+")
	...
	spellDamageLog = function(player, target, damage)
		...
		local dir, text = "../mithialua/History/logs/spell_log_" .. name .. "_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	swingDamageLog = function(player, target, damage)
		...
		local dir, text = "../mithialua/History/logs/swing_log_" .. name .. "_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	equipRestore = function(player)
		...
		local dir = "../mithialua/History/logs/characterlog/log_" .. name .. "_" .. os.date("%m.%d.%Y") .. ".txt"
		local file = io.open(dir, "a+")
	...
	bodLog = function(player)
		...
		local dir, text = "../mithialua/History/logs/death/bod_log_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")

		local name = string.lower(player.name)

		local dir2 = "../mithialua/History/logs/characterlog/log_" .. name .. "_" .. os.date("%m.%d.%Y") .. ".txt"
		local file2 = io.open(dir2, "a+")
	...
	deathPileLog = function(player)
		...
		local dir, text = "../mithialua/History/logs/death/deathpile_log_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	kanLogs = function(player, item, amount)
		...
		local dir, text = "../mithialua/History/logs/kan/kan_log_" .. name .. "_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	inputLog = function(player, string)
		...
		local dir, text = "../mithialua/History/logs/input/input_log_" .. os.date("%m.%d.%Y") .. ".txt", ""
		local file = io.open(dir, "a+")
	...
	worldShout = function(srcName, speech)
		local msg = srcName .. ": " .. speech
		broadcast(-1 ,msg )
	end
}
