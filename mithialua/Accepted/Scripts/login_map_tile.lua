login = function(player)
	...
	if player:hasLegend("born") == false then
		player:addLegend("Born in " .. curT(), "born", 74, 80)
	end

	player:msg(
		0,
		"Welcome, " .. player.name .. "! You have arrived in this small town.",
		player.ID
	)
	player:msg(
		0,
