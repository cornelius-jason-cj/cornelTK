    ...
    click = async(function(player, npc)
		...
		if choice == 'Star Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					player:addItem("star_scale_mail", 1)
				elseif player.sex == 1 then
					player:addItem("star_mail_dress", 1)
				end
		...
		if choice == 'Moon Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					if player:hasItem("star_scale_mail", 1) ~= true then
				...
				if player.sex == 1 then
					if player:hasItem("star_mail_dress", 1) ~= true then
						player:dialogSeq({t, "It seems you don't have star armor"}, 0)
						return
					end
				end
				...
				if player.sex == 0 then
					player:removeItem("star_scale_mail", 1)
					player:addItem("moon_scale_mail", 1)
				elseif player.sex == 1 then
					player:removeItem("star_mail_dress", 1)
					player:addItem("moon_mail_dress", 1)
				end
		...
		if choice == 'Sun Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					if player:hasItem("moon_scale_mail", 1) ~= true then
				...
				if player.sex == 1 then
					if player:hasItem("moon_mail_dress", 1) ~= true then
						player:dialogSeq({t, "It seems you don't have moon armor"}, 0)
						return
					end
				end
				...
				if player.sex == 0 then
					player:removeItem("moon_scale_mail", 1)
					player:addItem("sun_scale_mail", 1)
				elseif player.sex == 1 then
					player:removeItem("moon_mail_dress", 1)
					player:addItem("sun_mail_dress", 1)
				end
