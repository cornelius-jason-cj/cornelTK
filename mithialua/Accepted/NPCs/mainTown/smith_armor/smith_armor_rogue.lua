    ...
    click = async(function(player, npc)
		...
		if choice == 'Star Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					player:addItem("star_waistcoat", 1)
				elseif player.sex == 1 then
					player:addItem("star_blouse", 1)
				end
		...
		if choice == 'Moon Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					if player:hasItem("star_waistcoat", 1) ~= true then
				...
				if player.sex == 1 then
					if player:hasItem("star_blouse", 1) ~= true then
						player:dialogSeq({t, "It seems you don't have star armor"}, 0)
						return
					end
				end
				...
				if player.sex == 0 then
					player:removeItem("star_waistcoat", 1)
					player:addItem("moon_waistcoat", 1)
				elseif player.sex == 1 then
					player:removeItem("star_blouse", 1)
					player:addItem("moon_blouse", 1)
				end
		...
		if choice == 'Sun Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					if player:hasItem("moon_waistcoat", 1) ~= true then
				...
				if player.sex == 1 then
					if player:hasItem("moon_blouse", 1) ~= true then
						player:dialogSeq({t, "It seems you don't have moon armor"}, 0)
						return
					end
				end
				...
				if player.sex == 0 then
					player:removeItem("moon_waistcoat", 1)
					player:addItem("sun_waistcoat", 1)
				elseif player.sex == 1 then
					player:removeItem("moon_blouse", 1)
					player:addItem("sun_blouse", 1)
				end
