    ...
    click = async(function(player, npc)
		...
		if choice == 'Star Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					player:addItem("star_clothes", 1)
				elseif player.sex == 1 then
					player:addItem("star_skirt", 1)
				end
		...
		if choice == 'Moon Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					if player:hasItem("star_clothes", 1) ~= true then
				...
				if player.sex == 1 then
					if player:hasItem("star_skirt", 1) ~= true then
						player:dialogSeq({t, "It seems you don't have star armor"}, 0)
						return
					end
				end
				...
				if player.sex == 0 then
					player:removeItem("star_clothes", 1)
					player:addItem("moon_clothes", 1)
				elseif player.sex == 1 then
					player:removeItem("star_skirt", 1)
					player:addItem("moon_skirt", 1)
				end
		...
		if choice == 'Sun Armor' then
			...
			if choice2 == "Yes, let's craft" then
				...
				if player.sex == 0 then
					if player:hasItem("moon_clothes", 1) ~= true then
				...
				if player.sex == 1 then
					if player:hasItem("moon_skirt", 1) ~= true then
						player:dialogSeq({t, "It seems you don't have moon armor"}, 0)
						return
					end
				end
				...
				if player.sex == 0 then
					player:removeItem("moon_clothes", 1)
					player:addItem("sun_clothes", 1)
				elseif player.sex == 1 then
					player:removeItem("moon_skirt", 1)
					player:addItem("sun_skirt", 1)
				end
