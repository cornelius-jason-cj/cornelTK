...
local _shadowVitaOrMana = function(player, statIndex)
	...
	local statInterval = 50 / statIndex
...
ExpSellerNpc = {
	...
	showShadowMainMenu = function(player, npc)
		...
		-- 	if player.baseHealth >= 400000 then
		-- 		player:dialogSeq(
		-- 			{t, "You've reached the 400k Vita limit. Complete the Grade 1 Quest to raise it further."},
		-- 			0
		-- 		)
		-- 		return
		-- 	end

		-- 	if player.baseMagic >= 125000 then
		-- 		player:dialogSeq(
		-- 			{t, "You've reached the 125k Mana limit. Complete the Grade 1 Quest to raise it further."},
		-- 			0
		-- 		)
		-- 		return
		-- 	end
		...
		-- 	if player.baseHealth >= 350000 then
		-- 		player:dialogSeq(
		-- 			{t, "You've reached the 350k Vita limit. Complete the Grade 1 Quest to raise it further."},
		-- 			0
		-- 		)
		-- 		return
		-- 	end

		-- 	if player.baseMagic >= 175000 then
		-- 		player:dialogSeq(
		-- 			{t, "You've reached the 175k Mana limit. Complete the Grade 1 Quest to raise it further."},
		-- 			0
		-- 		)
		-- 		return
		-- 	end
		...
		-- 	if player.baseHealth >= 175000 then
		-- 		player:dialogSeq(
		-- 			{t, "You've reached the 175k Vita limit. Complete the Grade 1 Quest to raise it further."},
		-- 			0
		-- 		)
		-- 		return
		-- 	end

		-- 	if player.baseMagic >= 350000 then
		-- 		player:dialogSeq(
		-- 			{t, "You've reached the 350k Mana limit. Complete the Grade 1 Quest to raise it further."},
		-- 			0
		-- 		)
		-- 		return
		-- 	end
		...
		-- 	if player.baseHealth >= 325000 then
		-- 		player:dialogSeq(
		-- 			{t, "You've reached the 325k Vita limit. Complete the Grade 1 Quest to raise it further."},
		-- 			0
		-- 		)
		-- 		return
		-- 	end

		-- 	if player.baseMagic >= 225000 then
		-- 		player:dialogSeq(
		-- 			{t, "You've reached the 225k Mana limit. Complete the Grade 1 Quest to raise it further."},
		-- 			0
		-- 		)
		-- 		return
		-- 	end
