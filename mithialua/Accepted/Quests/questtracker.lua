...
questtracker = {
	...
	displayquest = function(player)
		...
		if  player.registry["killing_quest_mythic_rabbit"] == 1 then
			-- if (player.m >= 338 and player.m <= 345) then		
		        local questName = "killing_quest_mythic_rabbit"
				local mobs = huntingListQuest.mythic_rabbit.mobs	
				local killCount = questtracker.calculateKillCount(player, mobs)
				local maxKills = 500
				...
				text = "Total myhtic rabbit killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_monkey"] == 1 then
			-- if (player.m >= 346 and player.m <= 355) then		
				...
				text = "Total myhtic monkey killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_dog"] == 1 then
			-- if (player.m >= 356 and player.m <= 365) then		
				...
				text = "Total myhtic dog killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_rooster"] == 1 then
			-- if (player.m >= 374 and player.m <= 382) then	
				...
				text = "Total myhtic rooster killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_rat"] == 1 then
			-- if (player.m >= 366 and player.m <= 373) then	
				...
				text = "Total myhtic rat killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_horse"] == 1 then
			-- if (player.m >= 383 and player.m <= 391) then	
				...
				text = "Total myhtic horse killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_ox"] == 1 then
			-- if (player.m >= 392 and player.m <= 402) then
				...
				text = "Total myhtic ox killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_pig"] == 1 then
			-- if (player.m >= 403 and player.m <= 412) then
				...
				text = "Total myhtic pig killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_snake"] == 1 then
			-- if (player.m >= 413 and player.m <= 421) then
				...
				text = "Total myhtic snake killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_sheep"] == 1 then
			-- if (player.m >= 422 and player.m <= 435) then
				...
				text = "Total myhtic sheep killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end

		if  player.registry["killing_quest_mythic_tiger"] == 1 then
			-- if (player.m >= 437 and player.m <= 446) then
				...
				text = "Total myhtic tiger killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end
		
		if  player.registry["killing_quest_mythic_dragon"] == 1 then
			-- if (player.m >= 447 and player.m <= 455) then
				...
				text = "Total myhtic dragon killed " .. killCount .. "/" .. maxKills .. "\n\n"
			-- end
		end
