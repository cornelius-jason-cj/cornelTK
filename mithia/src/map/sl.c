...
int pcl_setattr(lua_State* state, USER* sd, char* attrname) {
  ...
  else if (!strcmp(attrname, "bonusMight")) sd->bonusMight = lua_pushnumber(state, -1);
  else if (!strcmp(attrname, "bonusGrace")) sd->bonusGrace = lua_pushnumber(state, -1);
  else if (!strcmp(attrname, "bonusWill")) sd->bonusWill = lua_pushnumber(state, -1);
  else if (!strcmp(attrname, "bonusArmor")) sd->bonusArmor = lua_pushnumber(state, -1);
  else if (!strcmp(attrname, "bonusDamage")) sd->bonusDamage = lua_pushnumber(state, -1);
  else if (!strcmp(attrname, "bonusCrit")) sd->bonusCrit = lua_pushnumber(state, -1);
  else if (!strcmp(attrname, "bonusHealing")) sd->bonusHealing = lua_pushnumber(state, -1);
  else if (!strcmp(attrname, "bonusLifeSteal")) sd->bonusLifeSteal = lua_pushnumber(state, -1);
  else if (!strcmp(attrname, "bonusReflect")) sd->bonusReflect = lua_pushnumber(state, -1);
...
int pcl_getattr(lua_State* state, USER* sd, char* attrname) {
  ...
  else if (!strcmp(attrname, "bonusMight")) lua_pushnumber(state, sd->bonusMight);
  else if (!strcmp(attrname, "bonusGrace")) lua_pushnumber(state, sd->bonusGrace);
  else if (!strcmp(attrname, "bonusWill")) lua_pushnumber(state, sd->bonusWill);
  else if (!strcmp(attrname, "bonusArmor")) lua_pushnumber(state, sd->bonusArmor);
  else if (!strcmp(attrname, "bonusDamage")) lua_pushnumber(state, sd->bonusDamage);
  else if (!strcmp(attrname, "bonusCrit")) lua_pushnumber(state, sd->bonusCrit);
  else if (!strcmp(attrname, "bonusHealing")) lua_pushnumber(state, sd->bonusHealing);
  else if (!strcmp(attrname, "bonusLifeSteal")) lua_pushnumber(state, sd->bonusLifeSteal);
  else if (!strcmp(attrname, "bonusReflect")) lua_pushnumber(state, sd->bonusReflect);
